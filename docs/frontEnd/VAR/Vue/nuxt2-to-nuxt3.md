...
> 本项目走的是ssr方式，所以部署区别于spa部署。spa一般将打包后的静态文件通过nginx部署，ssr部署需要使用node服务，可以使用[pm2守护进程进行docker部署](https://pm2.io/docs/runtime/integration/docker/)。PM2 docker部署见[这里](./nuxt3-ssr.md)
