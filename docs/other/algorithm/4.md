...
### 3.[K个一组翻转链表](https://link.juejin.cn/?target=https%3A%2F%2Fleetcode-cn.com%2Fproblems%2Freverse-nodes-in-k-group%2F)
...
+ 倒数第k个元素就是新的head, 先获取倒数第k+1个元素，再成环，最后断开
```ts
/**
 * Definition for singly-linked list.
 * class ListNode {
...
### 6.[合并k个升序链表](https://link.juejin.cn/?target=https%3A%2F%2Fleetcode-cn.com%2Fproblems%2Fmerge-k-sorted-lists%2F)
...
### 9.[两个链表的第一个公共节点](https://leetcode-cn.com/problems/liang-ge-lian-biao-de-di-yi-ge-gong-gong-jie-dian-lcof/)
